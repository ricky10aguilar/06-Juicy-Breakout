...
export var distort_x = 1.0
export var distort_y = 1.0
...
func _physics_process(delta):
	...
	$Tween.interpolate_property(self, "position",target, position.y, speed, Tween.TRANS_EXPO, Tween.EASE_OUT, Tween.EASE_OUT_IN)
